import {
  ...
  voidProcessor
} from "./chunk-O6SXC4UD.js";
import "./chunk-RP5LA7RX.js";
import {
  __commonJS,
  __export,
  __publicField,
...
var getPlatformProperties = () => {
  ...
  if (detectedPlatform === "deno") {
    return {
      ...
      "X-Stainless-Runtime-Version": typeof Deno.version === "string" ? Deno.version : ((_a4 = Deno.version) == null ? void 0 : _a4.deno) ?? "unknown"
    };
  }
  if (typeof EdgeRuntime !== "undefined") {
    return {
...
var createPathTagFunction = (pathEncoder = encodeURIPath) => function path2(statics, ...params) {
  ...
  const path3 = statics.reduce((previousValue, currentValue, index) => {
    ...
    value.toString === ((_a4 = Object.getPrototypeOf(Object.getPrototypeOf(value.hasOwnProperty ?? EMPTY) ?? EMPTY)) == null ? void 0 : _a4.toString))) {
      encoded = value + "";
  ...
  const choices = completion.choices.map((choice) => {
    ...
    return {
      ...
      message: {
        ...choice.message,
        ...choice.message.tool_calls ? {
          tool_calls: ((_a4 = choice.message.tool_calls) == null ? void 0 : _a4.map((toolCall) => parseToolCall(params, toolCall))) ?? void 0
        } : void 0,
...
function hasAutoParseableInput(params) {
  ...
  return ((_a4 = params.tools) == null ? void 0 : _a4.some((t) => isAutoParsableTool(t) || t.type === "function" && t.function.strict === true)) ?? false;
}
  ...
  async poll(runId, params, options) {
    ...
    const headers = buildHeaders([
      options == null ? void 0 : options.headers,
      {
        ...
        "X-Stainless-Custom-Poll-Interval": ((_a4 = options == null ? void 0 : options.pollIntervalMs) == null ? void 0 : _a4.toString()) ?? void 0
      }
    ]);
    while (true) {
    ...
    switch (event.type) {
      ...
      case "response.reasoning_text.delta": {
        ...
        if (output.type === "reasoning") {
          const content = (_a4 = output.content) == null ? void 0 : _a4[event.content_index];
          if (!content) {
            throw new OpenAIError(`missing content at index ${event.content_index}`);
          }
...
var OpenAI = class {
  ...
  async makeRequest(optionsInput, retriesRemaining, retryOfRequestLogID) {
    ...
    if ((_a4 = options.signal) == null ? void 0 : _a4.aborted) {
      throw new APIUserAbortError();
    }
...
var AzureOpenAI = class extends OpenAI {
  ...
  async buildRequest(options, props = {}) {
    ...
    if (_deployments_endpoints.has(options.path) && options.method === "post" && options.body !== void 0) {
      ...
      const model = this.deploymentName || options.body["model"] || ((_a4 = options.__metadata) == null ? void 0 : _a4["model"]);
...
function getFilenameFromMetadata(block) {
  var _a4, _b, _c;
  return ((_a4 = block.metadata) == null ? void 0 : _a4.filename) ?? ((_b = block.metadata) == null ? void 0 : _b.name) ?? ((_c = block.metadata) == null ? void 0 : _c.title);
}
...
function formatObjectProperties(obj, indent) {
  ...
  for (const [name, param] of Object.entries(obj.properties ?? {})) {
    ...
    if ((_a4 = obj.required) == null ? void 0 : _a4.includes(name)) lines.push(`${name}: ${formatType(param, indent)},`);
...
function parseArrayDef(def, refs) {
  ...
  if (((_b = (_a4 = def.type) == null ? void 0 : _a4._def) == null ? void 0 : _b.typeName) !== ZodFirstPartyTypeKind.ZodAny) {
...
var addFormat = (schema, value, message, refs) => {
  var _a4;
  if (schema.format || ((_a4 = schema.anyOf) == null ? void 0 : _a4.some((x) => x.format))) {
    if (!schema.anyOf) {
      schema.anyOf = [];
    }
    if (schema.format) {
...
var addPattern = (schema, regex, message, refs) => {
  var _a4;
  if (schema.pattern || ((_a4 = schema.allOf) == null ? void 0 : _a4.some((x) => x.pattern))) {
    if (!schema.allOf) {
      schema.allOf = [];
    }
    if (schema.pattern) {
      ...
      if (inCharGroup) {
        if (source[i].match(/[a-z]/)) {
          if (inCharRange) {
            ...
            inCharRange = false;
          } else if (source[i + 1] === "-" && ((_a4 = source[i + 2]) == null ? void 0 : _a4.match(/[a-z]/))) {
            pattern += source[i];
            inCharRange = true;
          } else {
...
function parseRecordDef(def, refs) {
  var _a4, _b, _c, _d;
  if (refs.target === "openApi3" && ((_a4 = def.keyType) == null ? void 0 : _a4._def.typeName) === ZodFirstPartyTypeKind.ZodEnum) {
    return {
      type: "object",
...
function parseObjectDef(def, refs) {
  const result = {
    ...
    ...Object.entries(def.shape()).reduce((acc, [propName, propDef]) => {
      ...
      if (parsedDef === void 0)
        return acc;
      if (refs.openaiStrictMode && propDef.isOptional() && !propDef.isNullable() && typeof ((_a4 = propDef._def) == null ? void 0 : _a4.defaultValue) === "undefined") {
...
function parseDef(def, refs, forceResolution = false) {
  ...
  if (refs.override) {
    const overrideResult = (_a4 = refs.override) == null ? void 0 : _a4.call(refs, def, refs, seenItem, forceResolution);
...
function handleMultiModalOutput(content, messages) {
  if (messages && typeof messages === "object" && "images" in messages && Array.isArray(messages.images)) {
    const images = messages.images.filter((image) => {
      var _a4;
      return typeof ((_a4 = image == null ? void 0 : image.image_url) == null ? void 0 : _a4.url) === "string";
    }).map((image) => ({
      type: "image",
  ...
  */
    ...
    if (this._streamResponseChunks === BaseChatModel2.prototype._streamResponseChunks || this.disableStreaming) yield this.invoke(input, options);
      ...
      try {
        for await (const chunk of this._streamResponseChunks(messages, callOptions, runManagers == null ? void 0 : runManagers[0])) {
          (_a4 = callOptions.signal) == null ? void 0 : _a4.throwIfAborted();
          if (chunk.message.id == null) {
            const runId = (_b = runManagers == null ? void 0 : runManagers.at(0)) == null ? void 0 : _b.runId;
        ...
        (_c = callOptions.signal) == null ? void 0 : _c.throwIfAborted();
      } catch (err) {
  ...
  async _generateUncached(messages, parsedOptions, handledOptions, startedRunManagers) {
    ...
    if (hasStreamingHandler && !this.disableStreaming && baseMessages.length === 1 && this._streamResponseChunks !== BaseChatModel2.prototype._streamResponseChunks) try {
      ...
      let llmOutput;
      for await (const chunk of stream) {
        if ((_a4 = parsedOptions.signal) == null ? void 0 : _a4.aborted) {
          const partialMessage = aggregated == null ? void 0 : aggregated.message;
      ...
      if ((_c = parsedOptions.signal) == null ? void 0 : _c.aborted) {
        const partialMessage = aggregated == null ? void 0 : aggregated.message;
        throw new ModelAbortError("Model invocation was aborted.", partialMessage);
      }
        ...
        if (pResult.status === "fulfilled") {
          ...
          for (const generation of result.generations) {
            if (generation.message.id == null) {
              const runId = (_a5 = runManagers == null ? void 0 : runManagers.at(0)) == null ? void 0 : _a5.runId;
          ...
          await ((_c2 = runManagers == null ? void 0 : runManagers[i]) == null ? void 0 : _c2.handleLLMError(pResult.reason));
    ...
    const output = {
      generations,
      llmOutput: llmOutputs.length ? (_d = this._combineLLMOutput) == null ? void 0 : _d.call(this, ...llmOutputs) : void 0
    };
...
var RouterRunnable = class extends Runnable {
  ...
  async batch(inputs, options, batchOptions) {
    ...
    const maxConcurrency = ((_a4 = optionsList[0]) == null ? void 0 : _a4.maxConcurrency) ?? (batchOptions == null ? void 0 : batchOptions.maxConcurrency);
...
Got ${JSON.stringify(parsedInputValue, null, 2)}`);
  ...
  async _enterHistory(input, kwargs) {
    var _a4;
    const history = (_a4 = kwargs == null ? void 0 : kwargs.configurable) == null ? void 0 : _a4.messageHistory;
  ...
  async _exitHistory(run, config2) {
    var _a4;
    const history = (_a4 = config2.configurable) == null ? void 0 : _a4.messageHistory;
    let inputs;
  ...
  */
  async parse(text) {
    ...
    try {
      ...
      const json2 = ((_a4 = trimmedText.match(/^```(?:json)?\s*([\s\S]*?)```/)) == null ? void 0 : _a4[1]) || ((_b = trimmedText.match(/```json\s*([\s\S]*?)```/)) == null ? void 0 : _b[1]) || trimmedText;
    ...
    if ("type" in schema) {
      ...
      if (schema.type === "object" && schema.properties) {
        ...
        const properties = Object.entries(schema.properties).map(([key, value]) => {
          var _a4;
          const isOptional = ((_a4 = schema.required) == null ? void 0 : _a4.includes(key)) ? "" : " (optional)";
...
var XMLOutputParser = class extends BaseCumulativeTransformOutputParser {
  ...
  getFormatInstructions() {
    ...
    return withTags ? XML_FORMAT_INSTRUCTIONS.replace("{tags}", ((_a4 = this.tags) == null ? void 0 : _a4.join(", ")) ?? "") : XML_FORMAT_INSTRUCTIONS;
  }
};
...
function makeInvalidToolCall(rawToolCall, errorMsg) {
  var _a4, _b;
  return {
    name: (_a4 = rawToolCall.function) == null ? void 0 : _a4.name,
...
var JsonOutputToolsParser = class extends BaseCumulativeTransformOutputParser {
  ...
  */
  async parsePartialResult(generations, partial = true) {
    ...
    let toolCalls;
    if (isAIMessage(message) && ((_a4 = message.tool_calls) == null ? void 0 : _a4.length)) toolCalls = message.tool_calls.map((toolCall) => {
...
var JsonOutputKeyToolsParser = class extends JsonOutputToolsParser {
  ...
  async _validateResult(result) {
    ...
    else throw new OutputParserException(`Failed to parse. Text: "${JSON.stringify(result, null, 2)}". Error: ${JSON.stringify((_a4 = zodParsedResult.error) == null ? void 0 : _a4.issues)}`, JSON.stringify(result, null, 2));
  }
  async parsePartialResult(generations) {
...
var BaseChatOpenAI = class extends BaseChatModel {
  constructor(fields) {
    ...
    */
    ...
    __publicField(this, "lc_serializable", true);
    const configApiKey = typeof ((_a4 = fields == null ? void 0 : fields.configuration) == null ? void 0 : _a4.apiKey) === "string" || typeof ((_b = fields == null ? void 0 : fields.configuration) == null ? void 0 : _b.apiKey) === "function" ? (_c = fields == null ? void 0 : fields.configuration) == null ? void 0 : _c.apiKey : void 0;
    this.apiKey = (fields == null ? void 0 : fields.apiKey) ?? configApiKey ?? getEnvironmentVariable("OPENAI_API_KEY");
  ...
  */
  _getReasoningParams(options) {
    ...
    if ((options == null ? void 0 : options.reasoningEffort) !== void 0 && (reasoning == null ? void 0 : reasoning.effort) === void 0) reasoning = {
      ...reasoning,
  ...
  */
  ...
  async getNumTokensFromMessages(messages) {
    ...
    const countPerMessage = await Promise.all(messages.map(async (message) => {
      ...
      if ((_a4 = openAIMessage.additional_kwargs) == null ? void 0 : _a4.function_call) count += 3;
  ...
  async _getNumTokensFromGenerations(generations) {
    const generationUsages = await Promise.all(generations.map(async (generation) => {
      var _a4;
      if ((_a4 = generation.message.additional_kwargs) == null ? void 0 : _a4.function_call) return (await this.getNumTokensFromMessages([generation.message])).countPerMessage[0];
...
var completionsApiContentBlockConverter = {
  ...
  fromStandardImageBlock(block) {
    ...
    if (block.source_type === "url") return {
      ...
      image_url: {
        url: block.url,
        ...((_a4 = block.metadata) == null ? void 0 : _a4.detail) ? { detail: block.metadata.detail } : {}
      }
    };
  ...
  fromStandardFileBlock(block) {
    ...
    if (block.source_type === "url") {
      ...
      return {
        ...
        file: {
          file_data: block.url,
          ...((_a4 = block.metadata) == null ? void 0 : _a4.filename) || ((_b = block.metadata) == null ? void 0 : _b.name) ? { filename } : {}
        }
      };
    }
    if (block.source_type === "base64") {
...
var convertCompletionsMessageToBaseMessage = ({ message, rawResponse, includeRawResponse }) => {
  ...
  switch (message.role) {
    case "assistant": {
      ...
      const content = handleMultiModalOutput(message.content || "", (_b = (_a4 = rawResponse.choices) == null ? void 0 : _a4[0]) == null ? void 0 : _b.message);
...
var convertMessagesToCompletionsMessageParams = ({ messages, model }) => {
  return messages.flatMap((message) => {
    var _a4, _b;
    if ("output_version" in message.response_metadata && ((_a4 = message.response_metadata) == null ? void 0 : _a4.output_version) === "v1") return convertStandardContentMessageToCompletionsMessage({ message });
    let role = messageToOpenAIRole(message);
    if (role === "system" && isReasoningModel(model)) role = "developer";
...
var ChatOpenAICompletions = class extends BaseChatOpenAI {
  ...
  invocationParams(options, extra) {
    ...
    const params = {
      ...
      tools: ((_a4 = options == null ? void 0 : options.tools) == null ? void 0 : _a4.length) ? options.tools.map((tool2) => this._convertChatOpenAIToolToCompletionsTool(tool2, { strict })) : void 0,
  ...
  async _generate(messages, options, runManager) {
    ...
    if (params.stream) {
      ...
      for await (const chunk of stream) {
        ...
        const index = ((_b = chunk.generationInfo) == null ? void 0 : _b.completion) ?? 0;
      ...
      for (const part of (data == null ? void 0 : data.choices) ?? []) {
        const text = ((_c = part.message) == null ? void 0 : _c.content) ?? "";
        const generation = {
          text,
  ...
  async *_streamResponseChunks(messages, options, runManager) {
    ...
    if (usage) {
      const inputTokenDetails = {
        ...((_c = usage.prompt_tokens_details) == null ? void 0 : _c.audio_tokens) !== null && { audio: (_d = usage.prompt_tokens_details) == null ? void 0 : _d.audio_tokens },
        ...((_e = usage.prompt_tokens_details) == null ? void 0 : _e.cached_tokens) !== null && { cache_read: (_f = usage.prompt_tokens_details) == null ? void 0 : _f.cached_tokens }
      };
      const outputTokenDetails = {
        ...((_g = usage.completion_tokens_details) == null ? void 0 : _g.audio_tokens) !== null && { audio: (_h = usage.completion_tokens_details) == null ? void 0 : _h.audio_tokens },
        ...((_i = usage.completion_tokens_details) == null ? void 0 : _i.reasoning_tokens) !== null && { reasoning: (_j = usage.completion_tokens_details) == null ? void 0 : _j.reasoning_tokens }
      };
      const generationChunk = new ChatGenerationChunk({
    ...
    if ((_k = options.signal) == null ? void 0 : _k.aborted) throw new Error("AbortError");
  }
...
function _constructAzureFields(fields) {
  this.azureOpenAIApiKey = (fields == null ? void 0 : fields.azureOpenAIApiKey) ?? (typeof (fields == null ? void 0 : fields.openAIApiKey) === "string" ? fields == null ? void 0 : fields.openAIApiKey : void 0) ?? (typeof (fields == null ? void 0 : fields.apiKey) === "string" ? fields == null ? void 0 : fields.apiKey : void 0) ?? getEnvironmentVariable("AZURE_OPENAI_API_KEY");
...
var AzureChatOpenAICompletions = class extends ChatOpenAICompletions {
  constructor(fields) {
    super(fields);
    __publicField(this, "azureOpenAIApiVersion");
    __publicField(this, "azureOpenAIApiKey");
    __publicField(this, "azureADTokenProvider");
    __publicField(this, "azureOpenAIApiInstanceName");
    __publicField(this, "azureOpenAIApiDeploymentName");
    __publicField(this, "azureOpenAIBasePath");
    __publicField(this, "azureOpenAIEndpoint");
...
var convertResponsesUsageToUsageMetadata = (usage) => {
  var _a4, _b, _c, _d;
  const inputTokenDetails = { ...((_a4 = usage == null ? void 0 : usage.input_tokens_details) == null ? void 0 : _a4.cached_tokens) != null && { cache_read: (_b = usage == null ? void 0 : usage.input_tokens_details) == null ? void 0 : _b.cached_tokens } };
...
var convertResponsesMessageToAIMessage = (response) => {
  ...
  for (const item of response.output) if (item.type === "message") {
    ...
    const reasoningText = (_a4 = item.summary) == null ? void 0 : _a4.map((s) => s.text).filter(Boolean).join("");
...
var convertResponsesDeltaToChatGenerationChunk = (event) => {
  ...
  if (event.type === "response.output_text.delta") content.push({
    ...
    if (((_b = (_a4 = event.response.text) == null ? void 0 : _a4.format) == null ? void 0 : _b.type) === "json_schema") additional_kwargs.parsed ?? (additional_kwargs.parsed = JSON.parse(msg.text));
    ...
    const reasoningText = (_c = event.item.summary) == null ? void 0 : _c.map((s) => s.text).filter(Boolean).join("");
    if (reasoningText) content.push({
      type: "reasoning",
      reasoning: reasoningText
    });
...
var convertStandardContentMessageToResponsesInput = (message) => {
  var _a4;
  const isResponsesMessage = AIMessage.isInstance(message) && ((_a4 = message.response_metadata) == null ? void 0 : _a4.model_provider) === "openai";
  function* iterateItems() {
    ...
    const resolveImageItem = (block) => {
      const detail = iife$1(() => {
        var _a5;
        const raw = (_a5 = block.metadata) == null ? void 0 : _a5.detail;
...
var convertMessagesToResponsesInput = ({ messages, zdrEnabled, model }) => {
  return messages.flatMap((lcMsg) => {
    ...
    if (role === "tool") {
      ...
      if ((_a4 = toolMessage.additional_kwargs) == null ? void 0 : _a4.customTool) return {
    ...
    if (role === "assistant") {
      ...
      const input = [];
      const reasoning = additional_kwargs == null ? void 0 : additional_kwargs.reasoning;
      const hasEncryptedContent = !!(reasoning == null ? void 0 : reasoning.encrypted_content);
...
var ChatOpenAIResponses = class extends BaseChatOpenAI {
  invocationParams(options) {
    ...
    const params = {
      ...
      tools: ((_a4 = options == null ? void 0 : options.tools) == null ? void 0 : _a4.length) ? this._reduceChatOpenAITools(options.tools, {
        stream: this.streaming,
        strict
      }) : void 0,
      ...
      text: (() => {
        ...
        const format = this._getResponseFormat(options == null ? void 0 : options.response_format);
  ...
  async _generate(messages, options, runManager) {
    ...
    if (invocationParams.stream) {
      ...
      return {
        ...
        llmOutput: { estimatedTokenUsage: (_b = finalChunk == null ? void 0 : finalChunk.message) == null ? void 0 : _b.usage_metadata }
      };
    } else {
      const data = await this.completionWithRetry({
  ...
  async completionWithRetry(request, requestOptions) {
    return this.caller.call(async () => {
      ...
      const clientOptions = this._getClientOptions(requestOptions);
      try {
        if (((_b = (_a4 = request.text) == null ? void 0 : _a4.format) == null ? void 0 : _b.type) === "json_schema" && !request.stream) return await this.client.responses.parse(request, clientOptions);
...
var ChatOpenAI = class ChatOpenAI2 extends BaseChatOpenAI {
  ...
  _useResponsesApi(options) {
    var _a4, _b, _c, _d, _e;
    const usesBuiltInTools = (_a4 = options == null ? void 0 : options.tools) == null ? void 0 : _a4.some(isBuiltInTool);
...
var AzureChatOpenAI = class extends ChatOpenAI {
  ...
  _getStructuredOutputMethod(config2) {
    ...
    if (this.model.startsWith("gpt-4o")) {
      if ((ensuredConfig == null ? void 0 : ensuredConfig.method) === void 0) return "functionCalling";
    }
...
var OpenAI$2 = class extends BaseLLM {
  constructor(fields) {
    ...
    __publicField(this, "bestOf");
    __publicField(this, "logitBias");
    __publicField(this, "model", "gpt-3.5-turbo-instruct");
    ...
    this.organization = ((_a4 = fields == null ? void 0 : fields.configuration) == null ? void 0 : _a4.organization) ?? getEnvironmentVariable("OPENAI_ORGANIZATION");
    this.model = (fields == null ? void 0 : fields.model) ?? (fields == null ? void 0 : fields.modelName) ?? this.model;
    if ((((_b = this.model) == null ? void 0 : _b.startsWith("gpt-3.5-turbo")) || ((_c = this.model) == null ? void 0 : _c.startsWith("gpt-4")) || ((_d = this.model) == null ? void 0 : _d.startsWith("o1"))) && !((_e = this.model) == null ? void 0 : _e.includes("-instruct"))) throw new Error([
  ...
  */
      ...
      const data = params.stream ? await (async () => {
        ...
        for await (const message of stream) {
          ...
          for (const part of message.choices) {
            ...
            runManager == null ? void 0 : runManager.handleLLMNewToken(part.text, {
              prompt: Math.floor(part.index / this.n),
              completion: part.index % this.n
            });
          }
        }
        if ((_a4 = options.signal) == null ? void 0 : _a4.aborted) throw new Error("AbortError");
        return {
          ...response,
          choices: choices$1
        };
  ...
  async *_streamResponseChunks(input, options, runManager) {
    ...
    for await (const data of stream) {
      ...
      yield chunk;
      runManager == null ? void 0 : runManager.handleLLMNewToken(chunk.text ?? "");
    }
    if ((_a4 = options.signal) == null ? void 0 : _a4.aborted) throw new Error("AbortError");
  }
...
var OpenAIEmbeddings = class extends Embeddings2 {
  constructor(fields) {
    ...
    __publicField(this, "model", "text-embedding-ada-002");
    /** @deprecated Use "model" instead */
    __publicField(this, "modelName");
    ...
    */
    ...
    __publicField(this, "timeout");
    __publicField(this, "organization");
    __publicField(this, "encodingFormat");
    __publicField(this, "client");
    __publicField(this, "clientConfig");
    __publicField(this, "apiKey");
    ...
    this.organization = ((_a4 = fieldsWithDefaults == null ? void 0 : fieldsWithDefaults.configuration) == null ? void 0 : _a4.organization) ?? getEnvironmentVariable("OPENAI_ORGANIZATION");
    ...
    this.encodingFormat = fieldsWithDefaults == null ? void 0 : fieldsWithDefaults.encodingFormat;
    this.clientConfig = {
      apiKey,
      organization: this.organization,
      dangerouslyAllowBrowser: true,
...
var AzureOpenAIEmbeddings = class extends OpenAIEmbeddings {
  constructor(fields) {
    ...
    this.azureOpenAIApiKey = (fields == null ? void 0 : fields.azureOpenAIApiKey) ?? (typeof (fields == null ? void 0 : fields.apiKey) === "string" ? fields == null ? void 0 : fields.apiKey : void 0) ?? getEnvironmentVariable("AZURE_OPENAI_API_KEY");
    this.azureOpenAIApiVersion = (fields == null ? void 0 : fields.azureOpenAIApiVersion) ?? (fields == null ? void 0 : fields.openAIApiVersion) ?? getEnvironmentVariable("AZURE_OPENAI_API_VERSION");
    this.azureOpenAIBasePath = (fields == null ? void 0 : fields.azureOpenAIBasePath) ?? getEnvironmentVariable("AZURE_OPENAI_BASE_PATH");
    this.azureOpenAIApiInstanceName = (fields == null ? void 0 : fields.azureOpenAIApiInstanceName) ?? getEnvironmentVariable("AZURE_OPENAI_API_INSTANCE_NAME");
...
var Tool = class extends StructuredTool {
  constructor(fields) {
    super(fields);
    __publicField(this, "schema", external_exports.object({ input: external_exports.string().optional() }).transform((obj) => obj.input));
  }
  /**
  * @deprecated Use .invoke() instead. Will be removed in 0.3.0.
  *
...
function tool(func, fields) {
  ...
  if (!fields.schema || isSimpleStringSchema || isStringJSONSchema) return new DynamicTool({
    ...fields,
    description: fields.description ?? ((_a4 = fields.schema) == null ? void 0 : _a4.description) ?? `${fields.name} tool`,
      ...
      return new Promise((resolve, reject) => {
        ...
        AsyncLocalStorageProviderSingleton.runWithConfig(pickRunnableConfigKeys(childConfig), async () => {
          ...
          try {
            ...
            if ((_a5 = config2 == null ? void 0 : config2.signal) == null ? void 0 : _a5.aborted) {
              cleanup();
              return;
            }
            cleanup();
...
var _a3;
var DallEAPIWrapper = (_a3 = class extends Tool {
  constructor(fields) {
    ...
    super(fields);
    __publicField(this, "name", "dalle_api_wrapper");
    __publicField(this, "description", "A wrapper around OpenAI DALL-E API. Useful for when you need to generate images from a text description. Input should be an image description.");
    __publicField(this, "client");
    __publicField(this, "model", "dall-e-3");
    __publicField(this, "style", "vivid");
    __publicField(this, "quality", "standard");
    __publicField(this, "n", 1);
    __publicField(this, "size", "1024x1024");
    __publicField(this, "dallEResponseFormat", "url");
    __publicField(this, "user");
  ...
  */
  processMultipleGeneratedUrls(response) {
    if (this.dallEResponseFormat === "url") return response.flatMap((res) => {
      var _a4;
      const imageUrlContent = ((_a4 = res.data) == null ? void 0 : _a4.flatMap((item) => {
        if (!item.url) return [];
        return {
          type: "image_url",
          image_url: item.url
      ...
      var _a4;
      const b64Content = ((_a4 = res.data) == null ? void 0 : _a4.flatMap((item) => {
  ...
  async _call(input) {
    ...
    let data = "";
    if (this.dallEResponseFormat === "url") [data] = ((_a4 = response.data) == null ? void 0 : _a4.map((item) => item.url).filter((url2) => url2 !== "undefined")) ?? [];
    else [data] = ((_b = response.data) == null ? void 0 : _b.map((item) => item.b64_json).filter((b64_json) => b64_json !== "undefined")) ?? [];
    return data;
  }
}, __publicField(_a3, "toolName", "dalle_api_wrapper"), _a3);
...
function webSearch(options) {
  ...
  return {
    type: "web_search",
    filters: ((_a4 = options == null ? void 0 : options.filters) == null ? void 0 : _a4.allowedDomains) ? { allowed_domains: options.filters.allowedDomains } : void 0,
    user_location: options == null ? void 0 : options.userLocation,
    search_context_size: options == null ? void 0 : options.search_context_size
  };
}
...
function convertContainer(container) {
  ...
  return {
    type: "auto",
    file_ids: container == null ? void 0 : container.fileIds,
    memory_limit: container == null ? void 0 : container.memoryLimit
  };
}
function codeInterpreter(options) {
  return {
    type: "code_interpreter",
    container: convertContainer(options == null ? void 0 : options.container)
  };
}
...
function imageGeneration(options) {
  return {
    ...
    input_fidelity: options == null ? void 0 : options.inputFidelity,
    input_image_mask: convertInputImageMask(options == null ? void 0 : options.inputImageMask),
    model: options == null ? void 0 : options.model,
    moderation: options == null ? void 0 : options.moderation,
    output_compression: options == null ? void 0 : options.outputCompression,
    output_format: options == null ? void 0 : options.outputFormat,
    partial_images: options == null ? void 0 : options.partialImages,
...
function computerUse(options) {
  const computerTool = tool(async (input, runtime) => {
    var _a4, _b;
    const aiMessage = (_a4 = runtime.state) == null ? void 0 : _a4.messages.at(-1);
    const computerToolCall = (_b = aiMessage == null ? void 0 : aiMessage.tool_calls) == null ? void 0 : _b.find((tc) => tc.name === "computer_use");
    const computerToolCallId = computerToolCall == null ? void 0 : computerToolCall.id;
